...
fun HomeView(
    ...
    Scaffold(
        ...
        topBar = {AppBarView(title= "Recipe App")},
        ...
        val wishlist = viewModel.getALLrecipes.collectAsState(initial = listOf())
...
fun RecipeItem(recipe: Recipe, onClick: () -> Unit){
    Card(modifier = Modifier
        ...
        Column(modifier = Modifier.padding(16.dp)){
            Text(text = recipe.title, fontWeight = FontWeight.ExtraBold)
